...
public class LoginPage {
    ...
    private final String XPATH_USERNAME = "//*[@id=\"mat-input-0\"]";
    private final String XPATH_PASSWORD = "//*[@id=\"mat-input-1\"]";
    private final String XPATH_LOGIN = "/html/body/app-root/mat-sidenav-container/mat-sidenav-content/div/app-login/div/div/div[2]/form/div[1]/button";
    public LoginPage(WebDriver driver) {
        this.driver = driver;

        driver.get(TestExecutionProperties.SPECTRANET_UAT);
    ...
    By usernameLocator = By.xpath(XPATH_USERNAME);
    By passwordLocator = By.xpath(XPATH_PASSWORD);
    By loginButtonLocator = By.xpath(XPATH_LOGIN);
